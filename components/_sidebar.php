        ...
        <div class="name-tag">
            ...
            <div class="status">Admin | 
                <form id="logout-form" method="POST" style="display: inline-block">
                    <button type="submit" style="background-color: transparent; color: white; border: 0px; font-size: 12px !important;" name="submit">Keluar</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="app.php?page=played/index" class="sidebar-menu-item">
                    ...
                    <div class="sidebar-text-item">Playeed</div>
                </a>
            </li>
        </ul>
    </div>
